            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('borrowing_details.index') }}">{{ $title }}</a></li>
    ...
    <section class="section">
        <div class="card kt-form-card">
            ...
            <div class="card-body">
                ...
                <form class="form form-horizontal" action="{{ route('borrowing_details.update', $borrowing_details->id) }}" method="POST">
                    <div class="form-body">
                        @csrf @method('patch')
                        ...
                        <div class="offset-md-3 ps-2 pt-2 d-flex gap-2">
                            ...
                            <a href="{{ route('borrowing_details.index') }}" class="btn btn-outline-secondary">Batal</a>
                        </div>
                  </div>
                </form>
            </div>
